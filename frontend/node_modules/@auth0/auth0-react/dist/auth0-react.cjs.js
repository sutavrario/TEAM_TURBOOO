...
var Auth0Provider = function (opts) {
    ...
    var client = React.useState(function () { return new ra(toAuth0ClientOptions(clientOpts)); })[0];
    ...
    var loginWithCustomTokenExchange = React.useCallback(function (options) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 2, 3, 5]);
                    return [4 /*yield*/, client.loginWithCustomTokenExchange(options)];
                case 1:
    ...
    var exchangeToken = React.useCallback(function (options) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, loginWithCustomTokenExchange(options)];
        });
    ...
    var getConfiguration = React.useCallback(function () { return client.getConfiguration(); }, [client]);
    var mfa = React.useMemo(function () { return client.mfa; }, [client]);
    var contextValue = React.useMemo(function () {
        return __assign(__assign({}, state), { getAccessTokenSilently: getAccessTokenSilently, getAccessTokenWithPopup: getAccessTokenWithPopup, getIdTokenClaims: getIdTokenClaims, loginWithCustomTokenExchange: loginWithCustomTokenExchange, exchangeToken: exchangeToken, loginWithRedirect: loginWithRedirect, loginWithPopup: loginWithPopup, connectAccountWithRedirect: connectAccountWithRedirect, logout: logout, handleRedirectCallback: handleRedirectCallback, getDpopNonce: getDpopNonce, setDpopNonce: setDpopNonce, generateDpopProof: generateDpopProof, createFetcher: createFetcher, getConfiguration: getConfiguration, mfa: mfa });
    }, [
        state,
...
exports.AuthenticationError = i;
exports.ConnectError = a;
exports.GenericError = r;
exports.InMemoryCache = we;
exports.LocalStorageCache = ye;
exports.MfaChallengeError = $i;
exports.MfaEnrollmentError = Qi;
exports.MfaEnrollmentFactorsError = ta;
exports.MfaError = Xi;
exports.MfaListAuthenticatorsError = Yi;
exports.MfaRequiredError = d;
exports.MfaVerifyError = ea;
exports.MissingRefreshTokenError = h;
exports.OAuthError = OAuthError;
exports.PopupCancelledError = u;
exports.PopupOpenError = l;
exports.PopupTimeoutError = c;
exports.TimeoutError = s;
exports.UseDpopNonceError = f;
exports.User = Ke;
