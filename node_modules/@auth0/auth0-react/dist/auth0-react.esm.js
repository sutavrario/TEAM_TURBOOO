...
var Auth0Provider = function (opts) {
    ...
    var client = useState(function () { return new ra(toAuth0ClientOptions(clientOpts)); })[0];
    ...
    var loginWithCustomTokenExchange = useCallback(function (options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var exchangeToken = useCallback(function (options) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    var getConfiguration = useCallback(function () { return client.getConfiguration(); }, [client]);
    var mfa = useMemo(function () { return client.mfa; }, [client]);
...
export { Auth0Context, Auth0Provider, i as AuthenticationError, a as ConnectError, r as GenericError, we as InMemoryCache, ye as LocalStorageCache, $i as MfaChallengeError, Qi as MfaEnrollmentError, ta as MfaEnrollmentFactorsError, Xi as MfaError, Yi as MfaListAuthenticatorsError, d as MfaRequiredError, ea as MfaVerifyError, h as MissingRefreshTokenError, OAuthError, u as PopupCancelledError, l as PopupOpenError, c as PopupTimeoutError, De as ResponseType, s as TimeoutError, f as UseDpopNonceError, Ke as User, initialContext, useAuth0, withAuth0, withAuthenticationRequired };
